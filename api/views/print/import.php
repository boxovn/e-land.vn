<div id="container-view-print">
    ...
    <div class="text-center">
        <h4 class="title-type-print">Phiếu nhập hàng</h4>
        <div>
    ...
    <table width="100%">
        <tr>
            <td class="text-right"><strong>Tiền hàng</strong></td>
            <td class="text-right">{{object.total_cart| number:0}} VND</td>
        </tr>
        <tr>
            <td class="text-right"><strong>Giảm giá</strong></td>
            <td class="text-right">{{object.discount| number:0}} VND</td>
        </tr>
        <tr>
            <td class="text-right"><strong>Tổng cộng</strong></td>
            <td class="text-right">{{object.real_total_cart| number:0}} VND</td>
        </tr>
    </table>
