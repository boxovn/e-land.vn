<div id="container-view-print">
    ...
    <div class="text-center">
        <h4 class="title-type-print">Phiếu trả hàng</h4>
        <div>
    ...
    <br/>
    <div>
        <strong>Khách hàng</strong> : {{object.name}}<br/>
        <strong>Số điện thoại</strong> : {{object.phone}}<br/>
        <strong>Địa chỉ</strong> : {{object.address}}
    </div>
