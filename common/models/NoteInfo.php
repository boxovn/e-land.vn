...
/**
 * This is the model class for table "note_infos".
 *
 * @property int $id
 ...
 */
class NoteInfo extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['district_id', 'province_id', 'status','type_id'], 'integer','message' => '{attribute} phải là số nguyên'],
			[['content'], 'string'],
    ...
    {
        return $this->hasMany(ArticleImage::className(), ['note_info_id' => 'id']);
    }
	public function getArticle(){
    
    return $this->hasOne(Article::className() ,['note_info_id' => 'id']);
    }
}
