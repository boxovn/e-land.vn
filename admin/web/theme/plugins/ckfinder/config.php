...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/uploads/userfiles/', //'/backend/web/uploads/userfiles/'
    'root'         => dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR.'uploads'.DIRECTORY_SEPARATOR.'userfiles',//'D:/xampp/htdocs/nguonbds_php/backend/web/uploads/userfiles', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
