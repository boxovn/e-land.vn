							 ...
							 [
								...
								'format' => 'raw',
								 'value' => function ($model) {                      
                                    return '<input '. ($model->status ? 'checked="checked"': '') . ' id="' . $model->id .'" value="'. $model->status .'" type="checkbox" name="selection[]"/><lablel '. ($model->status ? 'class="text-primary"': 'class="text-default"') . ' id="label'. $model->id .'">'. $model->status . '</label>';
                            },
                                'contentOptions' => ['style' => 'text-align:center;vertical-align: middle;'],
                               'headerOptions' => ['style' => 'width: 40%;text-align:center;'],
                            ],
