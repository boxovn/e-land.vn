    ...
    <div class="login-box-body">
        ...
        <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
            <div class="form-group has-feedback">
                <?= $form->field($model, 'username')->textInput(['autofocus' => true, 'class' => 'form-control'])->label("Tên đăng nhập"); ?>
                <span class="glyphicon glyphicon-user form-control-feedback" style="top: 25px;"></span>
            </div>
            <div class="form-group has-feedback">
                <?= $form->field($model, 'password')->passwordInput(['class' => 'form-control'])->label("Mật khẩu"); ?>
