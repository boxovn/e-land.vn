...
?>
		...
		<link href="<?php echo yii::$app->urlManager->baseUrl?>/theme/plugins/jquery.bxslider/jquery.bxslider.min.css" rel="stylesheet">
					    ...
					    <?php echo Alert::widget() ?>
					        <div class="box box-primary">
					            ...
					            <div class="box-body">
					                ...
					                <div class="row">   
							            <div class="col-md-12">  
							            	<div class="form-group">
									            ...
									            <div class="col-md-8">  
									              	<?php echo $apartmentCatalog->title; ?>
									            </div>
							              	</div>
						                </div>
							        </div> 
							        ...
							        <div class="row">
							        	<div class="col-md-12">  
							              	<form id="search-form-data" action="<?php echo yii::$app->urlManager->baseUrl?>/index.php?r=project%2Fchecked" method="post">
												<div class="form-group" style="padding-top: 40px;">
								              		...
								              		<div class="col-md-3">
								              			...
								              			<?php  
								              				$dataStatus = Project::listingCheckedStatus(); 
