...
?>
            ...
            <section class="content">
                <div class="row">
				    <div class="col-md-12">
					    ...
					    <!--form role="form" action="<?php echo yii::$app->urlManager->baseUrl?>/index.php?r=project%2Fadd" method="POST"-->
					        <div class="box box-primary">
					            ...
					            <div class="box-body">
					                ...
					                <div class="row">
							            ...
							            <div class="col-md-6">  
							            	<div class="form-group">
							              		<?php echo $form->field($model, 'category_type_id')->dropDownList(ArrayHelper::map(CategoryType::find()->orderBy(['title' => 'ASC'])->asArray()->all(),'id','title'), ['prompt'=>'Chọn'])->label("Phân loại chung cư"); ?>
						                	</div>
						                </div>
							        </div> 
							        ...
							        <div class="row">
							            <div class="col-md-12">
							            	<div class=""><label class="control-label">Hình ảnh</label> (Mỗi lần upload tối đa 5 hình [.jpg, .jpeg, .png])</div>
							            	<div action="<?php echo yii::$app->urlManager->baseUrl?>/index.php?r=project%2Fupload" 
					            ...
					            <div class="box-body">
					            	...
					            	?>
							            <div class="col-md-3">
							              	<div class="form-group">
							                	<label>
							                		<input id="internalCode_<?php echo $item['id']?>" value="<?php echo $item['id']?>" type="checkbox" class="internal-code" >
							        ...
							        <div class="row">
					            		<div class="col-md-12">
					            			<div class="form-group" id="divInternalService" style="<?php if ($model->internal_service_code) echo ''; else echo 'display: none;'; ?>">
							        ...
							        <div class="form-group">
					                    <input type="hidden" id="internal_service_code" name="Project[internal_service_code]" value="<?php echo $model->internal_service_code; ?>">
								    </div>
						    ...
						    <div style="padding-bottom: 100px; text-align: center;">
						    	<div class="row">
							    	...
							    	<div class="col-md-2">
							    		<button type="button" id="backButton" name="backButton" class="btn btn-warning">Quay lại</button>
							        </div>  
							        <div class="col-md-2">  
        ...
        $(document).ready(function() {
        	...
        	myDropzone.on("removedfile", function (file) {
                $.ajax({
        		    url: '<?php echo yii::$app->urlManager->baseUrl?>/index.php?r=project%2Fdelimage',
        		    type: 'post',
        		    data: {
        		    	id: file.id
        		    },
        	...
        	// */
      		...
      		// CKEditor init 
        	CKEDITOR.replace( 'Project-overview', {
        		language: 'vi',
        	...
        	CKEDITOR.replace( 'Project-external_service', {
        		language: 'vi',
        	    filebrowserImageBrowseUrl : '<?php echo yii::$app->urlManager->baseUrl?>/theme/plugins/ckfinder/ckfinder.html?type=Images',
        		filebrowserUploadUrl : '<?php echo yii::$app->urlManager->baseUrl?>/theme/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images'
        	} );
        	
        	CKEDITOR.replace( 'Project-internal_service', {
        		language: 'vi',
        	    filebrowserImageBrowseUrl : '<?php echo yii::$app->urlManager->baseUrl?>/theme/plugins/ckfinder/ckfinder.html?type=Images',
        		filebrowserUploadUrl : '<?php echo yii::$app->urlManager->baseUrl?>/theme/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images'
        	} );
        	...
        	//mapGetLocation(10.801250, 106.697012); // HCM location 
          	...
          	// Date picker
            //$('#Project-release_date').datepicker({
            //  	autoclose: true,
            //  	format: 'yyyy-mm-dd'
            //}); 
        ...
        $('#backButton').click(function(){
        	confirmAction('<?php echo yii::$app->urlManager->baseUrl?>/index.php?r=project%2Findex');
        });
		function confirmAction(url) {
        	$('#confirmExit').modal('show');
        	$('#confirmExit').on('click','#exitButton', function (e) {window.location = url + '&page=<?php echo $pageBack; ?>'});
        }
