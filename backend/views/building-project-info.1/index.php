...
?><!-- Content Wrapper. Contains page content -->
				        ...
				        <div class="box">
				            <div class="box-header">
				                ...
				                <div class="box-tools" style="top: 24px;">
				                    <a href="<?php echo yii::$app->urlManager->baseUrl?>/index.php?r=building-project-info%2Fadd" 
                    		...
                    		echo GridView::widget([
				                ...
				                'columns' => [
		                            ...
		                            [
		                                ...
		                                'format' => 'html',
		                                'value' => function ($data) {
		                                    return $data->checked_status == BuildingProjectInfo::CHECKED ? "<span class='text-success'>Tin đã duyệt</span>" : ($data->checked_status == BuildingProjectInfo::UNCHECKED ? "<span class='text-danger'>Tin chưa duyệt</span>" : "Tin chờ nhập");
		                                },
		                           ...
		                           //     'filter' => Yii::$app->user->identity->is_admin == 1 ? [1 => 'Tin đã duyệt', 0 => 'Tin chưa duyệt', 2 => 'Tin chờ nhập'] : [0 => 'Tin chưa duyệt', 2 => 'Tin chờ nhập']
									...
									[
		                                ...
		                                'format' => 'html',
		                                'value' => function ($data) {
											return "<a class='btn btn-sm btn-info back-click' href='" . yii::$app->urlManager->createUrl(['building-project-info/view', 'id' => $data->id]) . "'><i class='fa fa-eye'></i> Xem </a>&nbsp;" ."<a class='btn btn-sm btn-success back-click' href='" . yii::$app->urlManager->createUrl(['building-project-info/edit', 'id' => $data->id]) . "'><i class='fa fa-edit'></i> Sửa</a>";
		                               
		                                /*	if (Yii::$app->user->identity->is_admin == 1) {
		                                    	return "<a class='btn btn-sm btn-info back-click' href='" . yii::$app->urlManager->createUrl(['building-project-info/view', 'id' => $data->id]) . "'><i class='fa fa-eye'></i> Xem </a>&nbsp;" ."<a class='btn btn-sm btn-success back-click' href='" . yii::$app->urlManager->createUrl(['building-project-info/edit', 'id' => $data->id]) . "'><i class='fa fa-edit'></i> Sửa</a>" . "&nbsp;<a class='btn btn-sm btn-danger class_delete' href='" . yii::$app->urlManager->createUrl(['building-project-info/delete', 'id' => $data->id]) . "'><i class='fa fa-remove'></i> Xóa</a>";
		                                	} else {
		                                		return "<a class='btn btn-sm btn-info back-click' href='" . yii::$app->urlManager->createUrl(['building-project-info/view', 'id' => $data->id]) . "'><i class='fa fa-eye'></i> Xem </a>&nbsp;" ."<a class='btn btn-sm btn-success back-click' href='" . yii::$app->urlManager->createUrl(['building-project-info/edit', 'id' => $data->id]) . "'><i class='fa fa-edit'></i> Sửa</a>";
		                                	}*/
		                                },
        ...
        <script type="text/javascript">
		    jQuery(document).ready(function() {
		    	...
		    	if (jQuery("[name='BuildingProjectInfoSearch[checked_status]']").val() != '') {
		    		uriParam += '&BuildingProjectInfoSearch[checked_status]='+jQuery("[name='BuildingProjectInfoSearch[checked_status]']").val()
		    	}
		    	
		        jQuery('#w1').yiiGridView({
		            "filterUrl": "<?php echo yii::$app->urlManager->baseUrl?>/index.php?r=building-project-info%2Findex"+uriParam,
		            "filterSelector": "#w1-filters input"
		        });

		        jQuery("[name='BuildingProjectInfoSearch[checked_status]']").change(function() {
			        uriParam += '&BuildingProjectInfoSearch[checked_status]='+jQuery(this).val();
			        window.location = "<?php echo yii::$app->urlManager->baseUrl?>/index.php?r=building-project-info%2Findex"+uriParam;
		        });
