...
<div class="content-wrapper">
 <!-- Content Header (Page header) -->
        ...
        <?= Html::a('Sửa', ['update', 'id' => $note->id], ['class' => 'btn btn-warning btn-sm']) ?>
        <?= Html::a('Xóa', ['delete', 'id' => $note->id], [
					...
					<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
				        ...
				        <div class="box">
				            ...
				            <div class="box-body table-responsive">
								...
								<?= Html::a('Xóa', ['note-info/delete', 'id' => $noteInfo->id], [
									'class' => 'btn btn-danger btn-sm',
									'data' => [
										'confirm' => 'Are you sure you want to delete this item?',
										'method' => 'post',
                                ...
                                ?>
									<?php echo $form->field($noteInfo, 'title')->textInput(); ?>
									<?php echo $form->field($noteInfo, 'name')->textInput(); ?>
									<?php echo $form->field($noteInfo, 'phone')->textInput(); ?>
									<?php echo $form->field($noteInfo, 'width')->textInput(); ?>
									<?php echo $form->field($noteInfo, 'lenth')->textInput(); ?>
									<?php echo $form->field($noteInfo, 'area')->textInput(); ?>
									<?php echo $form->field($noteInfo, 'home')->textInput(); ?>
									<?php echo $form->field($noteInfo, 'price')->textInput(); ?>
									<?php echo $form->field($noteInfo, 'direction')->textInput(); ?>
									<?php echo $form->field($noteInfo, 'alley')->textInput(); ?>
									<?php echo $form->field($noteInfo, 'province_id')
											->dropDownList(
												...
												<?php echo $form->field($noteInfo, 'district_id')
											->dropDownList(
											...
											<?php echo $form->field($noteInfo, 'street')
												->textInput(['autocomplete' => 'off', 'placeholder'=> 'Số nhà, Thôn/Xóm, Ấp/Xã, Phường, Đường'])?>
											<?php echo $form->field($noteInfo, 'content')->widget(\yii\redactor\widgets\Redactor::className())?>
