                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <?php echo $form->field($model, 'category_id')->dropDownList($projectCategories, ['prompt'=>'Chọn'])->label("Phân loại chung cư"); ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                         ...
                                         <div class="row">
                                                    <div class="col-md-6">
                                                     ...
                                                     <div class="col-md-6">
                                                <div class="form-group">
                                                    <?php echo $form->field($model, 'progress')->dropDownList([0 => 'Đang thi công',1 => 'Sắp mở bán',2 => 'Đang mở bán', 3 =>'Đã hoàn thành'], ['prompt'=>'Chọn'])->label("Tiến độ"); ?>
                                                </div>
                                            </div>
                   ...
                   // 'header' => Html::a('Thêm', ['create','menu' => 'house'], ['class' => 'btn btn-primary btn-sm','style' => "width:100px" ]),
					'buttons'=>[
                        'view'=>function ($url, $model) {
                            ...
                            Yii::$app->params['elandUrl'] .'du-an/'. (isset($model->province)?$model->province->slug:'') .'/'.  (isset($model->district)?$model->district->slug :'') .'/' . $model->slug , ['target' => '_blank','class' => 'btn btn-primary btn-sm']);
					},
...
<?php echo $this->registerJsFile('@web/js/project.js');?>
<script>
