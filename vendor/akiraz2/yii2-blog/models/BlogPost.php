...
class BlogPost extends \yii\db\ActiveRecord
{
        ...
        return [
            ...
            [
                ...
                'value' => function ($event) {
                    ...
                    return Yii::$app->user->getId(); // 0;// Yii::$app->user->identity->id;//Yii::$app->user->getId();
                },
            ],
            [
    ...
    public function rules()
    {
        return [
            ...
            [['category_id', 'click', 'user_id','admin_id', 'status'], 'integer'],
            [['brief', 'content'], 'string'],
            [['banner'], 'file', 'extensions' => 'jpg, png, webp, jpeg', 'mimeTypes' => 'image/jpeg, image/png, image/webp, image/jpeg'],
    ...
    public function getUser()
    {
        if ($this->getModule()->userModel) {
            return $this->hasOne($this->getModule()->userModel::className(), [$this->getModule()->userPK => 'admin_id']);
        }
        return null;
    }
