...
class ImageManager extends \yii\db\ActiveRecord { 
	...
	public function attributeLabels() {
		return [
			...
			'file_name' => Yii::t('imagemanager', 'File Name'),
			'file_hash' => Yii::t('imagemanager', 'File Hash'),
	...
	public function getImagePathPrivate() {
		...
		$sFileExtension = pathinfo($this->file_name
, PATHINFO_EXTENSION);
		//get image file path
		$sImageFilePath = $sMediaPath . '/' . $this->id . '_' . $this->file_hash . '.' . $sFileExtension;
		//check file exists
