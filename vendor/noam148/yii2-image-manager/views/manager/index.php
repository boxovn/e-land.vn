...
<div id="module-imagemanager" class="container-fluid <?=$selectType?>">
    <div class="row">
        <div class="col-xs-6 col-sm-8 col-image-editor">
        ...
        <div class="col-xs-6 col-sm-8 col-overview">
            <?php Pjax::begin([
        ...
        <div class="col-xs-6 col-sm-4 col-options">
			...
			-->
					...
					?>
                    <a href="#" class="btn btn-xs btn-danger delete-image-item"><span class="glyphicon glyphicon-trash"
