...
class RentController extends AppController
{
  ...
  //  public $head= '';
	...
	public function actionArticleRegister() {
		$model = new User();
		...
		if (Yii::$app->request->isPost) {
			...
			return $this->renderAjax('article_register', ['model' => $model]);
		}
...
public function actionImageDetail() {
	...
	if (Yii::$app->request->isAjax) {
	 ...
	 public function actionIndex() {
		...
		$this->metaHead([
					...
					['property' => 'og:image','content' => $this->actual_link .'images/e-land.jpg'],
    ...
    public function actionDetail(){
				...
				$articleImages = $model->images;
				$articleDetail = $model->articleDetail;
				$articleType = $model->categoryType;
				$articleCategory = $model->categoryType->category;
