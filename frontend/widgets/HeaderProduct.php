...
class HeaderProduct extends yii\base\Widget{
	   public $slug = '';
	   public $province='';
	   public $district='';
	   public $type='';
    ...
    public function run() {
		...
		$articelCategories = Category::find()
       	...
       	return $this->render('header_product', ['blogCategories' => $blogCategories, 'articelCategories' => $articelCategories,'province' => $this->province,'slug' => $this->slug,'totalCount' => $this->totalCount]);
