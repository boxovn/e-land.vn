        ...
        <div class="box">
            <div class="box-body">
                <?php 
                 ...
                 if(isset($project->logo) && $project->logo){?>
                <img style="width: 60px;
                    ...
                    src="<?php echo Yii::$app->getUrlManager()->getBaseUrl() ?>/channels/projects/logo/<?php echo $project->logo;?>" />
                <?php }else{ ?>
                <img style="width: 60px;
                    height: 60px;
                    border-radius: 8px;
                    ...
                    margin-right: 10px;
                    border: 1px solid #eee;"
                    src="<?php echo Yii::$app->getUrlManager()->getBaseUrl() ?>/images/no-image200x200.png" />
                <?php }?>
                <div class="left">
                    <div class="title">
    ...
    <div class="col-md-7">
        <div class="index_nav">
            <ul class="ul_nav" style="list-style: none;">
                ...
                <li>
                    <a <?php  echo (Yii::$app->request->url==yii::$app->urlManager->createUrl(['/project/index']))? 'class="active"':'';?>
                        title="<?php echo $value->title;?>" href="<?php echo Url::to(['/project/index'],true);?>"><i
                            class="fa fa-caret-right" style="color:#c00" aria-hidden="true"></i>
                ...
                <li class="dropdown">
                    <a class="<?php  echo (explode('/',Yii::$app->request->url)[1]=='tin-tuc')? 'active':'';?> dropdown-toggle"
                        data-toggle="dropdown" href="#"> Xem thêm
...
<div class="mobile-topnav">
    ...
    <div class="mobi-nav-menu" id="myLinks">
        <ul>
            ...
            <?php if($value->slug=="du-an"){?>
            <li>
                <a class="active" title="<?php echo $value->title;?>"
                    href="<?php echo Url::to(['/project/index'],true);?>"><i class="fa fa-caret-right"
                        style="color:#c00" aria-hidden="true"></i> <?php echo $value->title;?></a>
            </li>
            <?php }else{?>
            <li>
                <a title="<?php echo $value->title;?>"
