...
<div class="container-fluid">
        <a class="d-block  d-lg-none d-xl-none btn-post" title="Đăng tin"   href="<?php echo yii::$app->urlManager->createUrl(['/index/login']) ?>"><i class="fa fa-address-card" aria-hidden="true"></i> Đăng tin</a>
