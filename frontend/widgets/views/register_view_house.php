...
<?php $this->registerJsFile(Yii::$app->request->baseUrl.'/e-land/js/register_view_house.js',['position' => \yii\web\View::POS_END]); ?>
...
<div class="widget widget-register">
     <h6 class="widget-title widget-title">Đăng ký xem nhà</h6> 
