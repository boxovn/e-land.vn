    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <h2 class="title">Sản phẩm thuộc dự án</h2>
            </div>
            
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <a href="<?php echo Url::to(['project/detail','slug' => $value->slug,'province' => isset($value->province)?$value->province->slug:'','district' =>  isset($value->district)?$value->district->slug:''],true);?>" class="btn btn-view">XEM TẤT CẢ</a>
            </div>
        </div>
        <div class="row row-border">
            ...
            <?php foreach($value->getArticles()->limit(2)->all() as $key => $value){?>
            ...
            <div class="col-pro col-6 col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                ...
                <div class="price">
                    <span class="price-left">
                        <?php echo $value->price_text;?>|  <?php echo $value->area_text;?>
                    </span>
                    <span class="price-right"> <?php echo$value->area?($value->price/$value->area).' triệu/m2':'(<span title="Chưa cập nhập">... </span>triệu/m2)';?></span>
                </div>
                <h3 class="wap-title">
            ...
            <div class="col-pro col-6 col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                ...
                <div class="price">
                    ...
                    <span class="price-right"> 333 triệu/m2</span>
                </div>
                <h3 class="wap-title">
                ...
                <div class="icon-dec">
                    <span><img src="<?php echo Yii::$app->getUrlManager()->baseUrl?>/e-land/img/infoicon (1).png"/> T.Bắc</span>
                    <span><img src="<?php echo Yii::$app->getUrlManager()->baseUrl?>/e-land/img/infoicon (2).png"/> 1</span>
                    <span><img src="<?php echo Yii::$app->getUrlManager()->baseUrl?>/e-land/img/infoicon (3).png"/> 2</span>
                </div>
                <div class="address">
                    <img src="<?php echo Yii::$app->getUrlManager()->baseUrl?>/e-land/img/infoicon (4).png"/>
                    <?php if(isset($value->district) && isset($value->province)){?>
