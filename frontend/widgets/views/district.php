...
<?php foreach ($districts as $key => $value) { ?>
	<a href="<?php echo Yii::$app->params['elandUrl'];?><?php echo $value->slug; ?>" title="<?php echo $value->name; ?>"><span class="label label-danger"><?php echo $value->type; ?> <?php echo $value->name; ?></span></a>
<?php } ?>
