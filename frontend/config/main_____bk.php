    ...
    'assetManager' => [
		...
		'class' => 'yii\web\AssetManager',
			...
			'bundles' => [
		                'yii\web\JqueryAsset' => [
		                    'js' => [
		                        YII_ENV_DEV ? 'jquery.js' : 'jquery.js',
                            ],
         ...
         'urlManager' => [
            ...
            'baseUrl' => '/',
             'rules' => [
              ...
              /*  'thue/<province>/<district>/<district_id>/<province_id>' => 'rent/district',
				'thue/<province>/<province_id>/<project_id>' => 'rent/province',
				'thue/<slug>/<project_id>' => 'rent/detail',
                'thue/<slug>' => 'rent/index',
                'thue' => 'rent/index',

                'mua/<province>/<district>/<district_id>/<province_id>' => 'buy/district',
				'mua/<province>/<province_id>/<project_id>' => 'buy/province',
				'mua/<slug>/<project_id>' => 'buy/detail',
                'mua/<slug>' => 'buy/index',
                'mua' => 'buy/index',
                */
