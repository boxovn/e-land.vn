                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                $links=[];
                                                                                        if($model->province){
                                                                                                ...
                                                                                                'url' => ['/article/province','province' => $model->province->slug],
                                                                                        ...
                                                                                        if($model->district){
                                                                                                ...
                                                                                                'url' => ['/article/district','province' => $model->province->slug,'district' => $model->district->slug],
                                                                                                'template' => "<li><b>{link}</b></li>", // template for this link only
                                                                                            ];
                                                                                        }
                                                                            ...
                                                                            <div class="item-info">
                                                                                ...
                                                                                <div class="col-address col text-left">
                                                                                    ...
                                                                                    :
                                                                                    <a
                                                                                        href="<?php echo Url::to(['/article/district','district' => $model->district->slug,'province' => $model->province->slug],true);?>">
                                                                                        <?php echo isset($model->district)?($model->district->type . ' '. $model->district->name):'';?>

                                                                                    </a>,
                                                                                    <a
                                                                                        href="<?php echo Url::to(['/article/detail', 'province' => isset($value->province)?$value->province->slug:'', 'district' => isset($value->district)?$value->district->slug:'', 'slug' => $model->slug],true);?>">
                                                                    ...
                                                                    <div class="article-content">
                                                                                <div class="blog-box-social-list">
                                                                                    <ul class="blog-box-social-list-icons" style="width: 54px; position: absolute; top: 0px;">
                                                                                            ...
                                                                                            <li class="btn1"> <a href="https://www.facebook.com/sharer.php?u=<?php echo Url::to(['article/detail', 'province' => isset($model->province)?$model->province->slug:'', 'district' => isset($model->district)?$model->district->slug:'', 'slug' => $model->slug],true);?>&amp;_ga=2.262799108.90586406.1618995599-1423784879.1617296165&amp;_gac=1.218485355.1619173958.Cj0KCQjw4ImEBhDFARIsAGOTMj9f1bqZ01lhTbLIUWSb_me2OwSR6MemqwQA4Fp34MF2Cguj9oZtTHUaAkR1EALw_wcB" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=220,width=600');return false;" target="_blank"> <i class="fab fa-facebook"></i> </a></li>
                                                                                           
                                                                                            <li class="btn3"> <a href="mailto:?body=<?php echo Url::to(['article/detail', 'province' => isset($model->province)?$model->province->slug:'', 'district' => isset($model->district)?$model->district->slug:'', 'slug' => $model->slug],true);?>" target="_blank"> <i class="fas fa-envelope"></i> </a></li>
                                                                                            <li class="btn4"> <a href="https://www.linkedin.com/shareArticle?url=<?php echo Url::to(['article/detail', 'province' => isset($model->province)?$model->province->slug:'', 'district' => isset($model->district)?$model->district->slug:'', 'slug' => $model->slug],true);?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fab fa-linkedin"></i> </a></li>
                                                                                            <li class="btn5 zalo-btn">
																								<div class="zalo-share-button" data-url="<?php echo Url::to(['article/detail', 'province' => isset($model->province)?$model->province->slug:'', 'district' => isset($model->district)?$model->district->slug:'', 'slug' => $model->slug],true);?>" data-oaid="579745863508352884" data-layout="2" data-color="white" data-customize=false></div>
																							</li>
                                                                                        </ul>
                                                                                </div>
                                                                    </div>
