        ...
        <div class="row row-slider mt-3 mb-3">
                                                                        <div class="col">
                                                                            <section class="slider-district slider">
                                                                                        <div>
                                                                                        <div class="img all"><a href="<?php echo Url::to(['article/province', 'province' => $models[0]->province->slug],true);?>">Tất cả</a></div>
                                                                                        </div>
                                                                                        <?php  foreach($districts as $key => $value){ ?>
                                                                                        <div>
                                                                                        <div class="img"><a href="<?php echo Url::to(['article/district','district' => $value->slug, 'province' => $value->province->slug],true);?>"><?php echo $value->type ;?> <?php echo $value->name;?></a></div>
                                                                                        </div>
                                                                                        <?php }?>
                                                                            </section>
                                                                        </div>
