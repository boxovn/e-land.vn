				...
				<div class="modal-header">
					<div class="row w-100 m-0">
                        <div class="col-md-12">
                            ...
                            <div class="md-btn"> 
								<div class="dropdown">
										<button class="btn dropdown-toggle" type="button" id="dropdownMenu1" data-  -toggle="dropdown" aria-expanded="false"><i class="far fa-lg fa-share-square"></i></button>
              ...
              <div class="widget widget-register">
                                                                           ...
                                                                           <?php 
                                                                            ...
                                                                            <div class="form-group">
                                                                                        ...
                                                                                        <?= Html::submitButton('<i class="fas fa-lg fa-house-user"></i> Đăng ký', ['class' => 'btn  btn-success mb-3 btn-register']) ?>
