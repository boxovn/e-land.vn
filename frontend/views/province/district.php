...
use frontend\widgets\NewArticleDistrict;
?>

<div class="body">
    <?php //echo NewArticleDistrict::widget(['title' => 'Tin rao mới nhất', 'type' => 'block']);?>
    <?php if($models){ ?>
    <div class="list-box">
         <div class="list-head">
...
<div style="text-align: center; margin-bottom: 20px">
    <a onClick="loadArticle('<?php echo isset($slug)? $slug:''?>','<?php echo isset($page)? $page:''?>')"
        class="button_post" style="color: #fff; background-color: #c00; padding: 5px 15px; text-decoration: none; cursor: pointer;
