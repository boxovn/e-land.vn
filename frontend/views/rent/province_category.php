...
use frontend\widgets\NewArticleCategory;
?>
<div class="body">
    <?php echo NewArticleCategory::widget(['title' => 'Tin rao mới nhất', 'type' => 'block']);?>
    <?php foreach ($models as $key => $type) {
		$articles =	$type->getArticles()->andWhere([ 'province_id' => $province->province_id])->andWhere('district_id!=""')->orderBy(['created' => SORT_DESC])->offset(0)->limit(10)->all();
	?>
        ...
        <div class="list-head">
            ...
            <div class="btn-view-more">
                <a class="btn btn-danger btn-sm"
                    href="<?php echo Url::to(['province-slug_category-or_slug_type-or_slug_district','province' => $province->slug,'slug' => $type->slug],true);?>">
                    Xem thêm</a>
            </div>
        </div>
        ...
        <div class="column">
            <div class="box-image">
                ...
                <div class="box-label">
                    ...
                    <div class="info">
                        <span style="color:rgb(118, 118, 118)"><?php echo $value->articleType->title; ?></span>
