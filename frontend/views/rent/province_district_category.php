...
<div class="body">
    <?php foreach ($models as $key => $type) {
		$articles =	$type->getArticles()->andWhere([ 'province_id' => $province->province_id, 'district_id' =>  $district->district_id])->andWhere('district_id!=""')->orderBy(['created' => SORT_DESC])->offset(0)->limit(10)->all();
	?>
