...
<?php
    ...
    <?php if($models){ ?>
        ...
        <div class="row row-slider mt-3 mb-3">
                                                                        <div class="col">
                                                                            <section class="slider-district slider">
                                                                                        <div>
                                                                                        <div class="img all"><a href="<?php echo Url::to(['rent/province', 'province' => $models[0]->province->slug],true);?>">Tất cả</a></div>
                                                                                        </div>
                                                                                        <?php  foreach($districts as $key => $value){ ?>
                                                                                        <div>
                                                                                        <div class="img <?php echo ($value->slug==yii::$app->request->get('district'))? 'active':'';?>"><a href="<?php echo Url::to(['rent/district','district' => $value->slug, 'province' => $value->province->slug],true);?>"><?php echo $value->type ;?> <?php echo $value->name;?></a></div>
                                                                                        </div>
                                                                                        <?php }?>
                                                                            </section>
                                                                        </div>
                                                ...
                                                <div class="column">
                                                    <div class="box-image">
                                                        ...
                                                        <div 
                                                            ...
                                                            data-url="<?php echo Url::to(['rent/detail', 'province' => isset($value->province)?$value->province->slug:'', 'district' => isset($value->district)?$value->district->slug:'','slug' => $value->slug],true);?>"
