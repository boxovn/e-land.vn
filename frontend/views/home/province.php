...
<div class="article">
  ...
  <div class="row">
    <div class="col-lg-4">
      <img class="rounded w-100" alt="<?php echo $models[0]->province->name;?>" src="<?php echo Yii::$app->getUrlManager()->getBaseUrl() ?>/provinces/<?php echo $models[0]->province->image;?>" />
    </div>
    <div class="col-lg-8">
      <div class="p-3 mt-4">
          <h1 class="display-4">Mua bán <?php echo $models[0]->province->name;?></h1>
          <p class="lead"><?php echo $models[0]->province->description;?></p>
    ...
    <div id="list-box" class="container">
        ...
        $image = $value->image?$value->image: 'no-image.png';?>
         <div class="col-6 col-xs-6 col-sm-4 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
