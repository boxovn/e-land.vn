         ...
         <div class="row row-slider">
            <div class="col">
                ...
                <section class="center slider">
                    ...
                    <div>
                        <div class="img"><a href="<?php echo Url::to(['rent/district','district' => $value->slug, 'province' => $value->province->slug],true);?>"><?php echo $value->type ;?> <?php echo $value->name;?></a></div>
                    </div>
                    <?php }?>
                ...
                <?php }else { ?>
                    ...
                    <div>
                        <div class="img"><a href="<?php echo Url::to(['rent/province','province' => $value->slug],true);?>"><?php echo $value->type ;?> <?php echo $value->name;?></a></div>
                    </div>
                    <?php }?>
